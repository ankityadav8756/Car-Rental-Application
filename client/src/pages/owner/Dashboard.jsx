...
const Dashboard = () => {
  ...
  return (
    ...
    <Title title="Admin Dashboard" subTitle="Mointor overall platform performance including total cars,bookings, revenue and recent activities"/>
    ...
    <div className='p-4 md:p-6 border border-borderColor rounded-md max-w-lg w-full'>
         ...
         {data.recentBookings.map((booking,index)=>(
            <div key={index} className='mt-4 flex items-center justify-between'>
                ...
                <div className='hidden md:flex items-center justify-centerw-12 h-12
